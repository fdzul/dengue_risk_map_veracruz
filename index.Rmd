...
hotspots_map(cve_ent = "30",
             locality = c("Poza Rica de Hidalgo", "Coatzintla"),
             hotspots = cases_hotspots_agebs19,
             static_map = FALSE)
...
### **<span style="color:#990000">Papantla</span>**
<html>
<head>
<style>
body {
...
```
  ...
  <div class="box b">
```{r forest_plotpapantla, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
```
  ...
  <div class="box c">
```{r power_law_plotpapantla,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
```
  ...
  <div class="box d">
```{r gauge_blocks_papantla, fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots %>% dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid %>%
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
```
  ...
  <div class="box e">
```{r gauge_AGEB_papantla, fig.align = "center", out.height='100%', out.width = '100%'}
...
### **<span style="color:#990000">Martínez</span>**
<html>
<head>
<style>
body {
...
<div class="wrapper">
  <div class="box a">
```{r hotspots_dengue_mtz}
hotspots_map(cve_ent = "30",
             locality = c("Martínez de la Torre", "Independencia"),
             hotspots = cases_hotspots_agebs19,
             static_map = FALSE)
...
```
  ...
  <div class="box b">
```{r forest_plot_mtz, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
```
  ...
  <div class="box c">
```{r power_law_mtz,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
```
  ...
  <div class="box d">
```{r gauge_blocks_mtz, fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots %>% dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid %>%
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
```
  ...
  <div class="box e">
```{r gauge_AGEB_mtz, fig.align = "center", out.height='100%', out.width = '100%'}
...
<div class="box f">
```{r gauge_casos_mtz, out.height='90%', out.width = '90%', fig.align = "center"}
...
### **<span style="color:#990000">Córdoba</span>**
<html>
<head>
<style>
body {
...
hotspots <- cases_hotspots_agebs19[loc,]
# Logistic Regression
glm.fit <- glm(hotspots_gi ~  DENV_2010 +  
                   DENV_2012 + DENV_2013  + DENV_2018 + DENV_2019 +
                   DENV_2021,
               data = hotspots, 
               family = binomial)
...
```
  ...
  <div class="box c">
```{r power_law_cordoba,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
```
  ...
  <div class="box d">
```{r gauge_blocks_cordoba, fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots %>% dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid %>%
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
```
  ...
  <div class="box e">
```{r gauge_AGEB_cordoba, fig.align = "center", out.height='100%', out.width = '100%'}
...
### **<span style="color:#990000">Orizaba</span>**
<html>
<head>
<style>
body {
...
hotspots <- cases_hotspots_agebs19[loc,]
# Logistic Regression
glm.fit <- glm(hotspots_gi ~ DENV_2008 + DENV_2010 +  DENV_2011 +
...
```
  ...
  <div class="box c">
```{r power_law_orizaba,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
```
  ...
  <div class="box d">
```{r gauge_blocks_orizaba, fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots %>% dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid %>%
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
```
  ...
  <div class="box e">
```{r gauge_AGEB_orizaba, fig.align = "center", out.height='100%', out.width = '100%'}
...
### **<span style="color:#990000">Cosamaloapan</span>**
<html>
<head>
<style>
body {
...
hotspots <- cases_hotspots_agebs19[loc,]
# Logistic Regression
glm.fit <- glm(hotspots_gi ~ DENV_2014 + DENV_2019 + DENV_2020 + DENV_2021,
               data = hotspots, 
               family = binomial)
...
```
  ...
  <div class="box c">
```{r power_law_cosamaloapan,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
```
  ...
  <div class="box d">
```{r gauge_blocks_cosamaloapan, fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots %>% dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid %>%
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
```
  ...
  <div class="box e">
```{r gauge_AGEB_cosamaloapan, fig.align = "center", out.height='100%', out.width = '100%'}
